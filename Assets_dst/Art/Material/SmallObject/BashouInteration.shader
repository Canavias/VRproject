...
Shader "Seat/Metal"
{
	Properties
	{
		...
		_InterationColor("InterationColor", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		uniform float4 _InterationColor;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( _InterationColor + ( _ReflectColor * ( texCUBElod( _CubeMap, float4( ( ( reflect( -i.viewDir , ase_worldNormal ) * _MetalTelling ) + _MetalOffset ), 2.0) ) * _ReflectIntensity ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18500
0;710;1423;641.0001;721.3211;607.2566;1;True;False
...
Node;AmplifyShaderEditor.Vector3Node;12;-867.0509,-34.4833;Inherit;False;Property;_MetalTelling;MetalTelling;1;0;Create;True;0;0;False;0;False;1,1,1;2,3.5,2;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;15;-689.7176,-10.48333;Inherit;False;Property;_MetalOffset;MetalOffset;3;0;Create;True;0;0;False;0;False;1,1,1;2.15,1,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-189.8525,193.8396;Inherit;False;Property;_ReflectIntensity;ReflectIntensity;2;0;Create;True;0;0;False;0;False;1;0.7;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;16;-70.65929,-263.8355;Inherit;False;Property;_ReflectColor;ReflectColor;4;0;Create;True;0;0;False;0;False;0,0,0,0;0.9371068,0.9371068,0.9371068,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;20;76.03598,-430.1358;Inherit;False;Property;_InterationColor;InterationColor;6;0;Create;True;0;0;False;0;False;0,0,0,0;0.5168505,0.5616996,0.5849056,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=35CFCC29F82044666392DFDE35DA2A754B3FFE9B