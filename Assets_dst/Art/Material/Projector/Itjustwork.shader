...
Shader "Itjustwork"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float clampResult41 = clamp( ( ( ( distance( _PointOffsetY , ( ase_worldPos.y - objToWorld34.x ) ) - _DissovleAmount ) - ( tex2D( _Noise1, uv_Noise1 ).r * _NoiseIntensity ) ) * _DissolveScale ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
0;798.6667;1194.333;552.3334;1557.224;118.7288;1.673178;True;False
Node;AmplifyShaderEditor.TransformPositionNode;34;-2858.5,582.846;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;35;-2835.168,397.5125;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;36;-2631.168,507.5125;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-2736.33,234.6503;Inherit;False;Property;_PointOffsetY;PointOffsetY;12;0;Create;True;0;0;False;0;False;0;-23;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DistanceOpNode;33;-2483.835,319.5125;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-2430.398,498.1578;Inherit;False;Property;_DissovleAmount;DissovleAmount;8;0;Create;True;0;0;False;0;False;0;0.37;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-1715.383,490.9208;Inherit;False;Property;_DissolveScale;DissolveScale;10;0;Create;True;0;0;False;0;False;0;1.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2;-630.7689,-643.2705;Inherit;False;Property;_BaseColor;BaseColor;5;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;21;-627.6102,-179.5543;Inherit;False;Property;_EdgeColor;EdgeColor;11;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;0.2625682,1.770416,7.590635,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=AD605C572801AD9059AD1A04C0D94AC6334F6425